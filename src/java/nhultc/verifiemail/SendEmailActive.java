...
public class SendEmailActive {
    ...
    public void sendEmailVerify(String toEmail, String codeRegister) {
        ...
        try {
            String to = toEmail;
            String from = "lenhu0460@gmail.com";
            ...
            Session session = Session.getInstance(properties, new javax.mail.Authenticator() {
                protected PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication("lenhu0460@gmail.com", "05112000");
                }
            });
            ...
            String siteURL = "http://localhost:8080/J3.L.P0016_ResourceSharing";
